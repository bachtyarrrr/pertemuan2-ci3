        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block">
                    ...
                    <p class="animated fadeInUp">We love the Web and the work we do.We work closely with our clients
                        to deliver </br> the best possible solutions for their needs</p>
                    <a href="#" target="_blank" class="btn btn-main animated fadeInUp">Free Bootstrap Templates</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 col-sm-12">
                <div class="block">
                    <img src="<?php echo base_url('assets/'); ?>images/wrapper-img.png" alt="Img">
                </div>
            </div><!-- .col-md-5 close -->
        </div>
    </div>
            ...
            <div class="col-md-5 col-md-offset-1">
                <div class="testimonial-carousel text-center">
                    <div class="testimonial-slider owl-carousel">
                        <div>
                            <i class="ion-quote"></i>
                            <p>"This Company created an e-commerce site with the tools to make our business a
                                success, with innovative ideas we feel that our site has unique elements that make
                                us stand out from the crowd."</p>
                            <div class="user">
                                <img src="<?php echo base_url('assets/'); ?>images/item-img1.jpg" alt="Pepole">
