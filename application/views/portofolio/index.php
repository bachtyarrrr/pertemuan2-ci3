                ...
                <div class="block">
                    ...
                    <div class="row shuffle-wrapper">
                        <div class="col-md-4 portfolio-item shuffle-item" data-groups="[&quot;design&quot;]">
                            <img src="<?php echo base_url('assets/'); ?>images/portfolio/work1.jpg" alt="">
                            <div class="portfolio-hover">
                                <div class="portfolio-content">
                                    <a href="<?php echo base_url('assets/'); ?>images/portfolio/work1.jpg"
                        ...
                        <div class="col-md-4 portfolio-item shuffle-item"
                            ...
                            <img src="<?php echo base_url('assets/'); ?>images/portfolio/work2.jpg" alt="">
                            <div class="portfolio-hover">
                                <div class="portfolio-content">
                                    <a href="<?php echo base_url('assets/'); ?>images/portfolio/work2.jpg"
                                        class="portfolio-popup"><i class="icon ion-search"></i></a>
                                    <a class="h3" href="portfolio-single.html">Rio Furniture</a>
                                    <p>Labore et dolore magna aliqua. Ut enim ad </p>
                                </div>
                        ...
                        <div class="col-md-4 portfolio-item shuffle-item" data-groups="[&quot;illustration&quot;]">
                            <img src="<?php echo base_url('assets/'); ?>images/portfolio/work3.jpg" alt="">
                            <div class="portfolio-hover">
                                <div class="portfolio-content">
                                    <a href="<?php echo base_url('assets/'); ?>images/portfolio/work3.jpg"
                                        class="portfolio-popup"><i class="icon ion-search"></i></a>
                                    <a class="h3" href="portfolio-single.html">Rio Furniture</a>
                                    <p>Labore et dolore magna aliqua. Ut enim ad </p>
                                </div>
